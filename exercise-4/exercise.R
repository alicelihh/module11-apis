...
query.params <- list(access_token = nty.apikey )
body <- "/reviews/search.json"
resource <- (GET("https://developer.nytimes.com/review/search.json"))
body <- fromJSON(content(resource, "text"))
